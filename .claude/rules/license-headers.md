...
> File paths in this document refer to the **nvme-cli** repository at
> `../nvme-cli/` relative to this repo.

nvme-cli contains two components with different licenses. Every new source file
added to nvme-cli must carry the correct SPDX identifier as its first line.
